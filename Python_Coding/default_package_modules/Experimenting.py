...
#     leaders_array1 = []
#     max1 = arr[n-1]
#     leaders_array1.append(max1)
#     for i in range(n-2,-1,-1):
#         if arr[i]>=max1:
#             max1 = arr[i];
#             leaders_array1.append(max1);
#         
#     return leaders_array1;
# 
# 
# T = int(input());
# for i in range(T):
...
#     #print(leaders)
#     print(' '.join(map(str, reversed(leaders_array))))    
# '''
# '''
# 2
# 2
...
# #     distances = []
# #     indicesOfX = [xi for xi in range(n) if arr[xi]==x]
# #     indicesOfY = [yi for yi in range(n) if arr[yi]==y]
# #     
# #     for each in indicesOfX:
# #         for each1 in indicesOfY:
# #             distances.append(abs(each-each1));
# #     
# #     return -1 if len(distances)==0 else min(distances);
# #     
# # 
# # t = int(input())
# # for i in range(t):
